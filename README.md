...
Лучше весь проект, со скриптами и фотографиями делать в одной папке. Как видно на скрине, все фото хранятся в папке Photos, эталонное изображение хранится в папке Ethalon. На скрине изображена папка со всем проектом курсовой. По сути нужны только папка Photos и Ethalon. Можно папку Photos создать в папке, которая скачивается в релизе. \
